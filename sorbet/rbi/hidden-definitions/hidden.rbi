...
class CFA::AugeasCollection
  ...
  def add(value, placer=T.unsafe(nil)); end
...
class CFA::AugeasError
end

class CFA::AugeasError
end

class CFA::AugeasInternalError
  def aug_message(); end
...
class CFA::AugeasSerializingError
  def aug_message(); end
...
class CFA::AugeasTree
  ...
  def add(key, value, placer=T.unsafe(nil)); end
...
class CFA::BaseModel
  ...
  def generic_get(key, tree=T.unsafe(nil)); end

  def generic_set(key, value, tree=T.unsafe(nil)); end

  def initialize(parser, file_path, file_handler: T.unsafe(nil)); end
...
class CFA::BaseModel
  ...
  def self.default_file_handler=(default_file_handler); end
end
...
class CFA::BooleanValue
  ...
  def initialize(name, model, true_value: T.unsafe(nil), false_value: T.unsafe(nil)); end
...
class CFA::Matcher
  def initialize(key: T.unsafe(nil), collection: T.unsafe(nil), value_matcher: T.unsafe(nil), &block); end
